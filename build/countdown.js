class CountdownTimer {
    constructor(elementID, birthDay, birthdayMessage) {
    ...
    countDown() {
        ...
        const min = Math.floor((timeLeft % (24 * 60 * 60 * 1000)) / (60 * 1000)) % 60;
        const sec = (Math.floor((timeLeft % (24 * 60 * 60 * 1000)) / 1000) % 60) % 60;
        const countDownTimerElement = document.getElementById(this.elementID);
        if (countDownTimerElement === null)
            return;
